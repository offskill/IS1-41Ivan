	...
	<head>
		...
		<body>	
						...
						<nav id="nav-menu-container">
							<ul class="nav-menu">
							  ...
							  <li class="menu-active"><a href="contact.php">Контакты</a></li>
								<li class="menu-active"><a class="reg-click" href="registration.php">Регистрация</a></li>
							</ul>
						</nav>	
			    	</div>
			    </div>
			...
			<section class="banner-area relative" id="home">
				...
				<div class="container">
					<form class="bg-color" method="post" action="registration.php">
						<div class="container">
							<h1 style="color: white">Регистрация</h1>
							<hr>
							<label for="email"><b>Логин</b></label>
							<input type="text" placeholder="Введите логин латиницей" name="login" pattern="[a-zA-Zа]+" required>
					
							<label for="psw"><b>Пароль</b></label>
							<input type="password" id="password1" placeholder="Введите пароль" name="password" required>
					
							<label for="psw-repeat"><b>Повтор пароля</b></label>
							<input type="password" id="password2" placeholder="Повторите пароль" name="password2" required>

							<label for="email"><b>Полное имя</b></label>
							<input type="text" placeholder="Введите ФИО" name="full_name" pattern="[А-Яа-яЁё\s]+" required>

							<label for="email"><b>Телефон</b></label>
							<input type="text" placeholder="В формате (XXX) XXX-XX-XX" name="phone" pattern="+7\(\d{3}\) \d{3}\d{2}\d{2}" required>
